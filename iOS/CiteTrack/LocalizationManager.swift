...
public class LocalizationManager: ObservableObject {
    ...
    private func addSupplementalKeys() {
        ...
        en["analysis_delete_confirm"] = en["analysis_delete_confirm"] ?? "Delete this analysis and its 海优 score? This cannot be undone."
        ...
        zh["analysis_delete_confirm"] = zh["analysis_delete_confirm"] ?? "删除该分析及其海优评分？此操作不可撤销。"
